...
class SubscriptionOrder(BaseModel):
    """Subscription orders created by users"""
    ...
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='subscription_orders')
    subscription_type = models.ForeignKey(SubscriptionType, on_delete=models.CASCADE, related_name='orders')
